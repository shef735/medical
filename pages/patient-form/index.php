...
<body>
    ...
    <div class="form-container">
        ...
        <form id="patientForm" method="post" action="saving.php" enctype="multipart/form-data">
            <div class="form-grid">
                <!-- Left Column -->
                <div class="form-column">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" required type="email" name="email" id="mail-email" placeholder="Email address">
                    </div>
                ...
                <div class="form-column">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="tel" name="phone" id="phone" placeholder="Contact / Phone Number">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="height_cm" id="height_cm" placeholder="Height in centimeters">
                    </div>
                    
                    <div class="form-group">
                        <label class="form-label" for="weight_kg">Weight (kg):</label>
                        <input class="form-control" type="number" name="weight_kg" id="weight_kg" placeholder="Weight in kilograms">
                    </div>
                </div>
                ...
                <div class="form-column">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Zip Code" name="ZipCode" id="ZipCode" type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="camera-section">
                ...
                <div class="camera-container">
                    ...
                    <input type="hidden" name="patient_photo_base64" id="patientPhotoBase64">
                </div>
            </div>
...
document.getElementById('uploadBtn').addEventListener('click', function() {
    ...
    if (file) {
        ...
        // Real address functionality using your existing PHP files
