...
<body>
    <div class="container">
        <div class="action-buttons">
            <a href="../patient-form/edit_patient_form.php?id=<?php echo htmlspecialchars($patient_id); ?>" class="btn btn-edit"><i class="fas fa-user-edit"></i>Edit Patient</a>
            ...
            <a href="../patient-list.php" class="btn btn-back"><i class="fas fa-arrow-left"></i>Back to List</a>
        </div>
            ...
            <div class="details-grid">
                <div class="column">
                    <div class="detail-item">
                        ...
                        ?>                       
                       <img src="../../uploads/patient-form/<?php echo $photo; ?>" alt="Patient Photo" style="text-align:center;width: 100%; max-width:100%; border-radius: 8px; border: 1px solid #ddd;" onerror="this.onerror=null;this.src='../../uploads/patient-form/default.png';">
                    </div>
                </div>
