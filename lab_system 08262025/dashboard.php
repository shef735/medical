                        ...
                        <tbody>
                            <?php foreach ($recent_tests as $test): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="view_result.php?id=<?php echo $test['result_id']; ?>" class="action-link" title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <?php if (hasRole('admin') || hasRole('technician')): ?>
                                            <a target="_blank" href="pdf_report.php?id=<?php echo $test['result_id']; ?>" class="action-link pdf-link" title="PDF">
