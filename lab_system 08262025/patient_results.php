                ...
                <tbody>
                    <?php foreach ($test_results as $test): ?>
                        <tr>
                            ...
                            <td class="actions">
                                <a target="_blank" href="view_result.php?id=<?php echo $test['result_id']; ?>">View Details</a>
                                <?php if (hasRole('admin') || hasRole('technician')): ?>
                                    <a  target="_blank" href="pdf_report.php?id=<?php echo $test['result_id']; ?>">PDF <span class="pdf-icon">📄</span></a>
                                 <!--   <a href="enter_results.php?edit=<?php // echo $test['result_id']; ?>">Edit</a> -->
                                <?php endif; ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
