...
?>
  <div class="form-group col-md-4">
                        <div class="form-label">House/ Building No. / Building Name</div>
                 		<input class="form-control" type="text" name="NoBldgName" id="NoBldgName" value="<?php echo $NoBldgName ?>"    >
                </div>
                
 <div class="form-group col-md-12">
         <div class="form-label">Unit No / Street / Subdivision</div> 
       
    	    <input type="text" class="form-control" name="StreetName" required id="StreetName" value="<?php echo $StreetName ?>"  >
        ...
        <div class="form-group col-md-6">
                        <div class="form-label">Region</div>
                            <select class="form-select" name="psgc_region" id="psgc_region"  required>
                                    ...
                                    echo '<option value="'.$psgc_region.'">'.$details.'</option>';
                  ...
                  <div class="form-group col-md-6">
                              ...
                              <select name="psgc_province" id="psgc_province" class="form-select" required  >
                      ...
                      <div class="form-group col-md-6">
                        <div class="form-label">Municipality</div>
                         <select name="psgc_municipality" id="psgc_municipality" class="form-select" required >
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-label">Barangay</div>
                         <select name="psgc_barangay" id="psgc_barangay" required  class="form-select" >
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input class="form-control" readonly class="form-control" name="ZipCode" id="ZipCode" type="text" placeholder="Enter Postal/zip Code">
                      </div>
