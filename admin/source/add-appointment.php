                  ...
                  <form>
                    <div class="row">
                      <div class="form-group col-md-4">
                        ...
                        <select class="form-select hidesearch" name="patienttitle[]">
                          <option value="patientitle">Title</option>
                      ...
                      <div class="form-group col-md-4">
                        <div class="form-label">Appointment With</div>
                        <input class="form-control" type="text" placeholder="Enter Doctor Name">
                      </div>
                      <div class="form-group col-md-4">
                        <div class="form-label">Appointment Date</div>
                        <input class="datepicker-here form-control" type="text" value="" data-date-format="dd/mm/yyyy" data-language="en" placeholder="Select Appointment Date">
                      </div>
                      <div class="form-group col-md-4">
                      ...
                      <div class="form-group col-md-4">
                        ...
                        <input class="form-control" type="text" placeholder="Enter Postal/zip Code">
                      </div>
                      <div class="form-group col-md-6">
                        <div class="form-label">Address</div>
                        <textarea class="form-control" placeholder="Enter Patient Address"></textarea>
                      </div>
                      <div class="form-group col-md-6">
                        <div class="form-label">Nots</div>
