          ...
          <div class="row">
            <div class="col-lg-4 col-sm-6">
              <div class="card support-box">
                <div class="card-body">
                  <div class="icon-wrap"><img class="img-fluid" src="../assets/images/support/1.png" alt=""></div>
                  <h5>Laboratory</h5>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="card support-box">
                <div class="card-body">
                  <div class="icon-wrap"><img class="img-fluid" src="../assets/images/support/2.png" alt=""></div>
                  <h5>Heart Surgery</h5>
                  <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                </div>
              </div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="card support-box">
                <div class="card-body">
                  <div class="icon-wrap"><img class="img-fluid" src="../assets/images/support/3.png" alt=""></div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="card support-box">
                <div class="card-body">
                  <div class="icon-wrap"><img class="img-fluid" src="../assets/images/support/4.png" alt=""></div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="card support-box">
                <div class="card-body">
                  <div class="icon-wrap"><img class="img-fluid" src="../assets/images/support/5.png" alt=""></div>
            ...
            <div class="col-lg-4 col-sm-6">
              <div class="card support-box">
                <div class="card-body">
                  <div class="icon-wrap"><img class="img-fluid" src="../assets/images/support/6.png" alt=""></div>
