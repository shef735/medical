...
<html lang="en">
  <head>
    ...
    <title>Medixo - Medical & Hospital Admin Template</title>
    <!-- shortcut icon-->
    ...
    <div class="auth-main">
      <div class="codex-authbox">
        <div class="auth-header">
          ...
          <p>You&apos;ve Successfully Verified Your Account. Enter <br> New Passeord Below.</p>
        </div>
        <form action="#">
          <div class="form-group">
            <label class="form-label">New Password</label>
            <div class="input-group group-input">
              <input class="form-control showhide-password" type="password" placeholder="Enter Your New Password" required=""><span class="input-group-text toggle-show fa fa-eye"></span>
            </div>
          </div>
          <div class="form-group">
            <label class="form-label">confirm password</label>
            <div class="input-group group-input">
              <input class="form-control showhide-password" type="password" placeholder="Re Enter Your Password" required=""><span class="input-group-text toggle-show fa fa-eye"></span>
            </div>
          </div>
