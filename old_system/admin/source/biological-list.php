...
?>
  ...
  <body>   
          ...
          <div class="row">
            ...
            <div class="col-12">
             ...
             <!--   <a class="btn btn-primary float-end mb-15" href="javascript:void(0);" 
                data-bs-toggle="modal" data-bs-target="#patientmodalmodal">Add Patient</a> -->
                   <h4><?php echo $_SESSION['biological'] ?> PATIENTS </h4> </br>
   ...
   $query = "SELECT * FROM ".$my_tables_use_check."_resources.patient_biological 
   WHERE UPPER(biological)='".$_SESSION['biological']."'"; 
    ...
    $query = mysqli_query($db_connection, $query);
      ...
      while ($company = mysqli_fetch_array($query)){
          ...
          echo '<tr>';
           ...
           echo '<td style="width:250px">'.$company['fullname'].'</td>';
          
             echo '<td>'.$company['diagnosis'].'</td>';
            
             echo '<td>'.$company['eims'].'</td>';
              echo '<td>'.$company['onset_var'].'</td>';
                echo '<td>'.$company['fistula'].'</td>';
                   echo '<td>'.$company['onset'].'</td>';
                      echo '<td>'.$company['obstruction'].'</td>';
                         echo '<td>'.$company['surgery'].'</td>';
                            echo '<td>'.$company['outcome'].'</td>';
                               echo '<td>'.$company['note'].'</td>';
        ...
        /*  echo '<td>
                <a href="edit-patient.html">
                  <i class="w-18" data-feather="edit"></i>
                   ...
                   <a class="text-primary ml-8" href="patient-load.php?id='.$company['user_id'].'">
