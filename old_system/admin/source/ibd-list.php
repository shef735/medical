...
?>
          ...
          <div class="row">
            ...
            <div class="col-12">
              ...
              <div class="card">  
                ...
                <div class="card-body">
                <!--<a class="btn btn-primary float-end mb-15" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#patientmodalmodal">Add Patient</a> -->
                   <h4><?php echo $_SESSION['ibd'] ?> PATIENTS </h4> </br>
  ...
  // $query = "SELECT * FROM ".$my_tables_use_check."_resources.patient_record 
  // WHERE UPPER(diagnosis1)='".$_SESSION['ibd']."'"; 

   $query = "SELECT p.*, r.*, p.id AS pid  
          FROM " . $my_tables_use_check . "_resources.patient_info p
          JOIN record_diagnosis r ON UPPER(p.user_id) = UPPER(r.user_id)
          WHERE SUBSTRING_INDEX(UPPER(r.diagnosis1),' ',1) = '".$_SESSION['ibd']."'";
    ...
    $query = mysqli_query($db_connection, $query);
      ...
      while ($company = mysqli_fetch_array($query)){
          ...
          echo '<td>'.$company['user_id'].'</td>';
           echo '<td>'.$company['last_name'].', '.$company['first_name'].'</td>';
            echo '<td>'.$gender.'</td>';
             echo '<td>'.$company['diagnosisyear'].'</td>';
        
          
              echo '<td>'.$company['attending'].'</td>';
                echo '<td>'.$company['hospital'].'</td>';
       ...
       /*   echo '<td>
                <a href="edit-patient.html">
                  <i class="w-18" data-feather="edit"></i>
                   ...
                   <a class="text-primary ml-8" href="../../daily-chart/view_patient.php?id='.$company['pid'].'">
...
?>             
                ...
                <!-- Patient Modal Start-->
                <div class="modal fade" id="patientmodalmodal">
                        ...
                        <form>
                          <div class="row">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select class="form-select form-control hidesearch" name="gender[]">
                            ...
                            <div class="form-group col-md-6">
                              ...
                              <select class="form-select form-control hidesearch" name="bloodgroup[]">
