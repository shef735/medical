    ...
    <div class="auth-main">
      <div class="codex-authbox">
        <div class="auth-header">
          <div class="codex-brand"><a href="index.php"><img class="img-fluid light-logo" src="../assets/images/logo/logo.png" alt=""></a></div>
          <h3>forgot password ?                 </h3>
          <p>Enter Your Email And We&apos;ll Send You A Link To Reset <br> Your Password.</p>
        </div>
        <form action="#">
          <div class="form-group mb-0">
            <label class="form-label">email</label>
            <input class="form-control" type="password" placeholder="Enter your email">
          </div>
          <div class="form-group mb-0">                  
