...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add_user'])) {
        ...
        if (empty($username) || empty($password) || empty($full_name)) {
            ...
            $check_sql = "SELECT * FROM ".$_SESSION['my_tables']."_laboratory.users WHERE username = '" . mysqli_real_escape_string($conn, $username) . "'";
        ...
        if (empty($full_name)) {
            ...
            $sql = "UPDATE ".$_SESSION['my_tables']."_laboratory.users SET 
    ...
    if ($user_id == $_SESSION['user_id']) {
        ...
        $sql = "DELETE FROM ".$_SESSION['my_tables']."_laboratory.users WHERE user_id = $user_id";
        if (mysqli_query($conn, $sql)) {
