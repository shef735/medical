            ...
            <tbody>
                <?php foreach ($report_data as $row): ?>
                    <tr>
                        ...
                        <td>
                            <a href="view_result.php?id=<?php echo $row['result_id']; ?>" class="action-link">View</a>
                            <a href="pdf_report.php?id=<?php echo $row['result_id']; ?>" class="action-link pdf-link">PDF</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
